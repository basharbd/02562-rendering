...
struct HitInfo {
  ...
  // Material properties populated during intersection
  diffuse: vec3f,
  ambient: vec3f,
  specular: vec3f,
  shininess: f32,
...
// Intersections and texture mapping
...
fn main_fs(@location(0) coords: vec2f) -> @location(0) vec4f {
  let uv = vec2f(coords.x * uf.aspect * 0.5, coords.y * 0.5);
