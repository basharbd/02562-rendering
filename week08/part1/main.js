...
// Global camera zoom state
let g_zoomValue = 1.0;

// -------------------------------------------------------------------------
// UI Event Listeners and Interaction Setup
// -------------------------------------------------------------------------
...
// -------------------------------------------------------------------------
// Main WebGPU Application Entry Point
// -------------------------------------------------------------------------
async function main() {
    // ---------------------------------------------------------------------
    // WebGPU Context and Device Initialization
    // ---------------------------------------------------------------------
    ...
    // ---------------------------------------------------------------------
    // Material and Light Buffer Setup
    // ---------------------------------------------------------------------
    ...
    // ---------------------------------------------------------------------
    // Accumulation Textures (Ping-Pong Rendering)
    // ---------------------------------------------------------------------
    ...
    // ---------------------------------------------------------------------
    // Render Loop and State Management
    // ---------------------------------------------------------------------
    let frame = 0;
    const noOfJitters = 1;
